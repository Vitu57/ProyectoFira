...
<div class="tablas" id="resultado">
	<form style="text-align: center;background-color: rgba(255,255,255,1);width: 60%;position: absolute;" action="#" method="POST" onsubmit="filtrar();return false">
	...
	<form style="text-align: center; margin-left: 60%;" action="#" method="POST" onsubmit="vertodo();return false">
