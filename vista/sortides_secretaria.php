...
?>
<body class="home" style="text-align: center; padding-top: 2%; padding-left: 5%; padding-right: 5%;" onload="tutorialsecre(); tutorialCSV(); tutoriallogout(); tutorialreturn();">
...
<?php
	echo "<p style='position:relative; float:right; margin-right:2%;'>".$nombre[0]."</p>";
	?>
