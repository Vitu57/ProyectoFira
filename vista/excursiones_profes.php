...
if (isMobile()) {
	...
	?>
			<form action="#" method="POST" onchange="CrearTablaProfes(2);return false" style="">
		...
		<input class="btn btn-lg" style="margin-right:4%; margin-left: 1%; padding: 0.5%; color: white; background-color: #367cb3; " type="submit" name="submit" value="Veure Tots" onclick="CrearTablaProfes(1);return false">
	</form>
	<br>
