...
<p class="h4 mb-4">Eliminar Alumne</p>
...
<!-- Sign up button -->
<?php
echo '<button class="btn btn-info mt-4 btn-block" type="submit" id="anadir" onclick="eliminarAlumno();return false;">Eliminar</button>'
?>
<div id="mensaje">
