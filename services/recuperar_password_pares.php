...
<body>
  ...
  <p>Si vols cambiar la clau fes click al següent enllaç y actualitza la teva contrasenya <a href='http://localhost/daw/ProyectoFira/vista/canvi_clau_pares.php?usuari=".$id."'>Canviar la contrasenya</a>.</p>
